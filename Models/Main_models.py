...
from utils.utils import samples_random
...
class Subnet1(nn.Module):
    ...
    def forward(self, args, img_featrue, points, faces_cuda, num_points, num_samples, prune):
        ...
        if prune:
            ...
            faces_cuda_bn = prune_func(faces_cuda_bn.detach(), out_error_estimator.detach(), args.tau, index_sample, 'max', device = self.cuda_device)
        else:
            faces_cuda_bn = None
