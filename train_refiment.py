...
for epoch in range(args.epoch):
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        choice = np.random.choice(points.size(1), args.num_vertices, replace=False) #Take ASIS
        points_choice = points[:, choice, :].contiguous() #Take ASIS
        ...
        # boundery - Take ASIS - we had no time to implement 
